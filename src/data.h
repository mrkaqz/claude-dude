...
static void _applyJson(const char* line, TamaState* out) {
  ...
  // Bridge sends {"time":[epoch_sec, tz_offset_sec]}. This board has no
  // RTC (M5.Rtc doesn't exist here) — settimeofday() is the equivalent:
  // sets the system clock, which any future time()/localtime() call reads.
